...
(function() {
   ...
   ormmaview.expand = function( URL ) {
	  try {
		 ...
		 if ( ( typeof expandProperties.width != "undefined" ) && ( expandProperties.width != null ) ) {
			cmd += ", 'w', '" + expandProperties.width + "'";
		 }
		 if ( ( typeof expandProperties.height != "undefined" ) && ( expandProperties.height != null ) ) {
    ...
    *
    */
   ormmaview.resize = function( width, height, x, y, allowOffscreen ) {
